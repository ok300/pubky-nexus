...
/// Checks multiple set memberships in a single pipeline call.
///
/// This function efficiently checks whether each member exists in its corresponding set
...
pub async fn check_members_batch(
    prefix: &str,
    checks: &[(&str, &str)],
